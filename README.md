# Nager.Date Public Holidays MCP Server

This is an MCP (Model Context Protocol) server that provides access to the Nager.Date Public Holidays API. It enables AI agents and LLMs to interact with Nager.Date Public Holidays through standardized tools.

## Features

- 🔧 **MCP Protocol**: Built on the Model Context Protocol for seamless AI integration
- 🌐 **Full API Access**: Provides tools for interacting with Nager.Date Public Holidays endpoints
- 🐳 **Docker Support**: Easy deployment with Docker and Docker Compose
- ⚡ **Async Operations**: Built with FastMCP for efficient async handling

## API Documentation

- **Nager.Date Public Holidays Website**: [https://date.nager.at](https://date.nager.at)
...
*Note: Replace `example_tool` with actual Nager.Date Public Holidays API tools based on the documentation.*
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Traia-IO/nagerdate-public-holidays-mcp-server.git
   cd nagerdate-public-holidays-mcp-server
   ```
...
1. Create API client functions for Nager.Date Public Holidays endpoints
...
"capabilities": [
  ...
  "tags": ["nager.date public holidays", "api"],
  "ref": "main"
}
```
